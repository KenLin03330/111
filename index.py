...
@app.route("/")
def index():
    homepage = "<h1>林浚承Python1127網頁</h1>"
    homepage += "<a href=/mis>MIS</a><br>"
    homepage += "<a href=/today>顯示日期時間</a><br>"
    homepage += "<a href=/welcome?nick=tcyang>傳送使用者暱稱</a><br>"
    homepage += "<a href=/about>林浚承簡介網頁</a><br>"
    homepage += "<a href=/account>網頁表單輸入帳密傳值</a><br>"
    homepage += "<br><a href=/read>人選之人演員查詢</a><br>"
    homepage += "<br><a href=/books>圖文精選</a><br>"
    homepage += "<br><a href=/query>圖文搜尋</a><br>"
    homepage += "<br><a href=/spider>網路爬蟲抓取子青</a><br>"
...
def query():
    if request.method == "POST":
        ...
        return render_template("20231111.html")
